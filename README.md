...
5. **Interfaces**. This defines the explicit contracts through which units interact. limiting knowledge of internal state and preventing behavior from depending on undocumented assumptions.
